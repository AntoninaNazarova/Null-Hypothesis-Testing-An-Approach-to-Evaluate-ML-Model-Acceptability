...
This repository contains datasets and source codes for submitted paper on "Null Hypothesis Testing: An Approach to Evaluate ML Model Acceptability". The provided files are associated with the dataset partitioning approaches and the feedforward neural network design used in the study.
